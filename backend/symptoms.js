...
export const bodyParts = ["Head", "Brain", "Eyes", "Ears", "Nose", "Mouth", "Teeth", "Tongue", "Throat", "Neck", "Shoulders", "Arms", "Elbows", "Wrists", "Hands", "Fingers", "Chest", "Heart", "Lungs", "Ribs", "Back", "Spine", "Abdomen", "Stomach", "Liver", "Kidneys", "Pancreas", "Intestines", "Small intestine", "Large intestine", "Bladder", "Gallbladder", "Spleen", "Appendix", "Esophagus", "Trachea", "Diaphragm", "Pelvis", "Genitals", "Prostate", "Ovaries", "Uterus", "Testes", "Buttocks", "Hips", "Legs", "Thighs", "Knees", "Calves", "Ankles", "Feet", "Toes", "Skin", "Muscles", "Tendons", "Ligaments", "Joints", "Blood vessels", "Arteries", "Veins", "Lymph nodes", "Nerves", "Bones", "Bone marrow"];
